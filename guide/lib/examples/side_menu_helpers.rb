    ...
    def side_menu_with_sub_items
      <<~RAW
        = dsfr_side_menu(title: "Test") do |component|
          ...
          = component.with_item(title: "Documentation", path: "#") do |item|
            = item.with_sub_item(title: "Guide d'utilisation", path: "#") do |sub_item|
              = sub_item.with_sub_item(title: "Installation", path: "#")
              = sub_item.with_sub_item(title: "Configuration", path: "#")
